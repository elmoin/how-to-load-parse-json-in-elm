...
var _user$project$Main$userView = function (user) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('mdl-list__item mdl-list__item--three-line')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('material-icons mdl-list__item-avatar')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('person')
							])),
						A2(
						_elm_lang$html$Html$span,
						_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(user.username)
							])),
						A2(
						_elm_lang$html$Html$i,
						_elm_lang$core$Native_List.fromArray(
...
var _user$project$Main$usersView = function (users) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('mdl-list')
			]),
		A2(_elm_lang$core$List$map, _user$project$Main$userView, users));
};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {users: a, statusMsg: b};
	});
...
var _user$project$Main$User = F4(
	function (a, b, c, d) {
		return {id: a, name: b, username: c, address: d};
	});
var _user$project$Main$Address = F3(
	function (a, b, c) {
		return {street: a, city: b, zipcode: c};
	});
var _user$project$Main$addressDecoder = A4(
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'street', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'zipcode', _elm_lang$core$Json_Decode$string));
var _user$project$Main$userDecoder = A5(
	...
	A2(_elm_lang$core$Json_Decode_ops[':='], 'address', _user$project$Main$addressDecoder));
var _user$project$Main$usersDecoder = _elm_lang$core$Json_Decode$list(_user$project$Main$userDecoder);
var _user$project$Main$UsersError = function (a) {
	return {ctor: 'UsersError', _0: a};
};
var _user$project$Main$UsersSuccess = function (a) {
	return {ctor: 'UsersSuccess', _0: a};
};
var _user$project$Main$getUsers = A3(
	_elm_lang$core$Task$perform,
	_user$project$Main$UsersError,
	_user$project$Main$UsersSuccess,
	A2(_evancz$elm_http$Http$get, _user$project$Main$usersDecoder, './users.json'));
		...
		switch (_p0.ctor) {
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{statusMsg: 'error trying to load users'}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('mdl-cell mdl-cell--6-col mdl-cell--3-offset content')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('mdl-button mdl-js-button mdl-button--raised btn-more'),
								_elm_lang$html$Html_Events$onClick(_user$project$Main$LoadUsers)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Load Users')
							])),
						_elm_lang$core$List$isEmpty(model.users) ? A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('mdl-typography--headline')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(model.statusMsg)
